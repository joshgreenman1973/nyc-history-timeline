...
## What this is
A **curated** selection of 394 turning points — not a comprehensive chronicle. Events were chosen to span the full arc of the city across six eras:
...
## Fact-checking
Four independent review passes. The build-time passes are described below; the September 2026 pass — which re-read every card, tested all 835 links and corrected eleven errors, two duplicate events and a chronological sorting bug — is written up in [FACT-CHECK.md](FACT-CHECK.md), including the claims it deliberately left standing and why.
